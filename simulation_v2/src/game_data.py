...
UPGRADES = {
    ...
    'extra_attack': Upgrade('extra_attack', 2, special_effect="extra_attack"),
...
LIMITS = {
    ...
    'unreliable_2': Limit('unreliable_2', 2, 3, 10),
    'unreliable_3': Limit('unreliable_3', 1, 7, 15),
    'quickdraw': Limit('quickdraw', 2, 3, 0),
    'patient': Limit('patient', 3, 1, 0),
    'finale': Limit('finale', 3, 2, 0),
    'charge_up': Limit('charge_up', 2, 3, 0),
