...
export class CharacterLibrary {
    ...
    renderLibrary() {
        ...
        if (characters.length === 0) {
            container.innerHTML = '<p class="empty-library">No saved characters yet. Create your first character to get started!</p>';
            return;
        }

        // Sort characters by last modified date (newest first)
        characters.sort((a, b) => {
            ...
            <div class="character-card" data-character-id="${character.id}">
                <div class="character-info">
                    ...
                    <div class="character-meta">
                        <span class="last-modified">Modified: ${this.formatDate(character.lastModified || character.created)}</span>
                    </div>
                </div>
                <div class="character-actions">
                    <button class="btn btn-primary btn-sm" data-action="load-character" data-character-id="${character.id}">Load</button>
                    <button class="btn btn-secondary btn-sm" data-action="duplicate-character" data-character-id="${character.id}">Copy</button>
                    <button class="btn btn-danger btn-sm" data-action="delete-character" data-character-id="${character.id}">Delete</button>
                </div>
            </div>
        `).join('');
